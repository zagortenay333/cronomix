...
var DatePickerItem = class DatePickerItem {
    constructor (label) {
        ...
        this.btn_up.add_actor(new St.Icon({ gicon : MISC_UTILS.get_icon('timepp-pan-up-symbolic') }));

        this.btn_down = new St.Button({ can_focus: true, style_class: 'arrow-btn' });
        arrow_box.add_actor(this.btn_down);
        this.btn_down.add_actor(new St.Icon({ gicon : MISC_UTILS.get_icon('timepp-pan-down-symbolic') }));
