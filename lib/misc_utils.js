...
//
// - A single whitespace char is used as a delim. (not greedy)
// - Whitespace can be included by escaping it with a backlash ('\').
// - Newline chars are split into separate tokens.
//
// Example output: ['as\ df', '\n', '\n', '  qwert\ y  ']
//
// NOTE: get rid of the spaces around newlines when concating the words
//       ['token', '\n', 'token'].join(' ').replace(/ ?\n ?/, '\n');
