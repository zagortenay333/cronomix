...
var Fullscreen = class Fullscreen {
    constructor (monitor) {
        ...
        this.banner_container.connect('allocation-changed', () => {
            if (this.is_open && !this.banner_container_handler_block) this._fit_banner();
        });
    ...
    _fit_banner (caller) {
        ...
        // @HACK For whatever reason after we are done resizing the label the
        // fullscreen ui can lose focus and we leak clicks to the ui underneath.
        // Calling set_child_above_sibling() seems to fix it...
