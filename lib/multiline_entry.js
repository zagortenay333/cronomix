...
var MultiLineEntry = new Lang.Class({
    ...
    _init: function(hint_text, scrollable, single_line_mode) {
        ...
        this.text_constraint = new Clutter.BindConstraint({ source: this.entry, coordinate: Clutter.BindCoordinate.POSITION });
        this.entry.clutter_text.add_constraint(this.text_constraint);
        ...
        this.entry.clutter_text.connect('activate', () => { if (this.automatic_newline_insert) this.insert_newline(); });
        ...
        this.entry.connect('allocation_changed', () => {
            this.text_constraint.offset = this.entry.get_theme_node().get_vertical_padding();
            this._resize_entry();
        });
