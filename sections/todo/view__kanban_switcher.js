...
var KanbanSwitcher = new Lang.Class({
    ...
    _init: function (ext, delegate, task) {
        ...
        Mainloop.idle_add(() => this.delegate.actor.add_style_class_name('view-kanban-switcher'));
    ...
    _add_new_item: function (kan_str, task) {
        ...
        // listen
        this.delegate.sigm.connect_press(item.check_icon, Clutter.BUTTON_PRIMARY, true, () => this._on_kanban_selected(item));
    ...
    close: function () {
        this.delegate.actor.remove_style_class_name('view-kanban-switcher');
