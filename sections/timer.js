...
var SectionMain = class SectionMain extends ME.imports.sections.section_base.SectionBase {
    constructor (section_name, ext, settings) {
        ...
        // panel item
        //
        this.panel_item.icon.gicon = MISC_UTILS.get_icon('timepp-timer-symbolic');
        ...
        //
        this.timepicker_container = new St.Bin();
    ...
    start (time) {
        ...
        this.start_pause_icon.gicon = MISC_UTILS.get_icon('timepp-pause-symbolic');
    ...
    stop () {
        ...
        this.start_pause_icon.gicon = MISC_UTILS.get_icon('timepp-start-symbolic');
    ...
    _send_notif () {
        ...
        if (notif_type === NotifStyle.NONE) {
            ...
            let icon = new St.Icon({ gicon : MISC_UTILS.get_icon('timepp-timer-symbolic') });
            let params = {
                bannerMarkup : true,
                gicon        : icon.gicon,
            };
...
var TimerPresetsView = class TimerPresetsView {
    ...
    _new_preset_item (preset) {
        ...
        let start_icon = new St.Icon({ track_hover: true, can_focus: true, reactive: true, gicon : MISC_UTILS.get_icon('timepp-start-symbolic') });
